...
public class TrieBasedSpellChecker extends NGramSpellChecker {
        ...
        while(candidates.size() > 0) {
            ...
            if(trie.search(candidateName)) {
                ...
                if (candidate.getCurrentPenalty() > penaltyLimit - 1 || candidate.getCurrentIndex() >= candidateName.length() - 1) {
                    ...
                    candidates.addAll(generateTrieCandidates(candidate));
                }
            }
        }
     ...
     */
    private HashSet<TrieCandidate> generateTrieCandidates(TrieCandidate candidate) {
        HashSet<TrieCandidate> candidates = new HashSet<>();
        ...
        Character[] characters = trie.getTrieNode(currentName.substring(0, currentIndex)).getChildren().keySet().toArray(new Character[0]);
